...
- **Volume Management** - Persistent storage with file operations
- **Network Pool** - Port allocation and management
...
See the [Authentication Guide](/api-reference/authentication) for token management.
...
<CardGroup cols={2}>
  ...
  <Card title="Containers" icon="box" href="/api-reference/containers">
    Container lifecycle management
  </Card>
  <Card title="WebSocket" icon="bolt" href="/api-reference/websocket">
    Real-time monitoring and control
  </Card>
  <Card title="Remote Sync" icon="cloud" href="/api-reference/remote">
