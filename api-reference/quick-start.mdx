...
- API token (see [Authentication](/api-reference/authentication))
...
<CardGroup cols={2}>
  <Card title="Volumes API" icon="hard-drive" href="/api-reference/volumes">
    Learn about file operations and compression
  </Card>
  <Card title="Containers API" icon="box" href="/api-reference/containers">
    Explore container lifecycle management
  </Card>
  <Card title="WebSocket API" icon="bolt" href="/api-reference/websocket">
    Real-time monitoring and control
  </Card>
  <Card title="Response Examples" icon="code" href="/api-reference/response-examples">
